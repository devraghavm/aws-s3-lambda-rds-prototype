...
BEGIN
  ...
  (
    ...
    tax_period VARCHAR(6) NOT NULL,
    check_digit VARCHAR(2) NOT NULL,
    state_taxable_wages_1 VARCHAR(13) NOT NULL,
    exception_indicator VARCHAR(1) NOT NULL,
    experience_rate_1 VARCHAR(6) NOT NULL,
    state_taxable_wages_2 VARCHAR(13) NOT NULL,
    unity_of_enterprise VARCHAR(1) NOT NULL,
    experience_rate_2 VARCHAR(6) NOT NULL,
    state_taxable_wages_3 VARCHAR(13) NOT NULL,
    experience_rate_3 VARCHAR(6) NOT NULL,
    state_taxable_wages_4 VARCHAR(13) NOT NULL,
    experience_rate_4 VARCHAR(6) NOT NULL,
    payment_sum_prior_21 VARCHAR(13) NOT NULL,
    payment_sum_btw_21_n_210 VARCHAR(13) NOT NULL,
    payment_sum_after_21 VARCHAR(13) NOT NULL,
    rate_indicator VARCHAR(1) NOT NULL,
    state_reporting_number VARCHAR(15) NOT NULL,
    form_indicator VARCHAR(1) NOT NULL,
    cross_reference_number VARCHAR(9) NOT NULL,
